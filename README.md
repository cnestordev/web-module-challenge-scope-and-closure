...
b. Compare and contrast calling `dansRoll` the first and second time. What is always the same? What could change?
    ...
    The thing that stays the same is the closure - that is, the name variable with its assigned value.
    Because dansRoll is a function definition, and inside of it the newRoll is declared and assigned, the newRoll will keep generating a new value each time the function is called.
